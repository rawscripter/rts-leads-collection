    ...
    var _demo = function () {
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: HOST_URL + '/table/data/questions',
                    },
                },
            ...
            columns: [{
                ...
                width: 100,
                template: function (data) {
                    return '<span class="font-weight-bolder">' + data.gender + '</span>';
                }
            }, {
                field: 'total_options',
                ...
                sortable: false,
                template: function (data) {
                    return '<span class="font-weight-bolder">' + data.total_options + '</span>';
                }
            }, {
                field: 'created_at',
                title: 'Added At',
            ...
            },
                {
                    ...
                    autoHide: false,
                    template: function (data) {
                        return '\<a href="' + data.edit_url + '" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">\
