    ...
    <div class="offcanvas-content pr-5 mr-n5">
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-50 mr-5">
                <div class="symbol symbol-25 symbol-light-success  flex-shrink-0">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    ...
                    <a onclick="event.preventDefault(); document.getElementById('frm-logout').submit();"
                       href="javascript:void(0)" class="btn btn-sm btn-primary text-white font-weight-bolder py-2 px-5">Sign
                        Out</a>
