@include('layouts.admin.inc.user-quick-panel.user-quick-panel')
                ...
                <div class="quick-search-result">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            ...
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">AirPlus
                                    Requirements</a>
                        ...
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            ...
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">TechNav
                                    Documentation</a>
                        ...
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            ...
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">Finance &amp;
                    ...
                    <div class="mb-10">
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            ...
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">79 PSD files
                                    generated</a>
                                <span class="font-size-sm font-weight-bold text-muted">by Grog John</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            ...
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">$2900 worth products
                                    sold</a>
                        ...
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            ...
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">4 New items
                                    submitted</a>
                                <span class="font-size-sm font-weight-bold text-muted">Marketing Manager</span>
                            </div>
                        </div>
